...
{
    public abstract class theslowprojectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static theslowprojectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(theslowprojectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<theslowprojectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<theslowprojectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<theslowprojectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<theslowprojectDbContext, Task<T>> func)
        {
            T result;
